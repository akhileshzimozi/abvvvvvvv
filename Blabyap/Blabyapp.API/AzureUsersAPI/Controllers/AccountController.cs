...
using AzureUsersAPI.Models;
using AzureUsersAPI.Providers;
using AzureUsersAPI.Results;
using Blabyap.Common.Model;

namespace AzureUsersAPI.Controllers
{
    [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        [AllowAnonymous]
        [Route("Register")]
        public async Task<IHttpActionResult> Register(RegisterInfo model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
