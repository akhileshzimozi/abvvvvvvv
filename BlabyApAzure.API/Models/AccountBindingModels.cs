...
namespace BlabyApAzure.API.Models
{
    ...
    public class ChangePasswordBindingModel
    {
        ...
        public static implicit operator ChangePassword(ChangePasswordBindingModel registerMdl)
        {
            return new ChangePassword()
            {
                OldPassword = registerMdl.OldPassword,
                NewPassword = registerMdl.NewPassword,
                ConfirmPassword = registerMdl.ConfirmPassword
            };
        }

        public static implicit operator ChangePasswordBindingModel(ChangePassword regInfo)
        {
            return new ChangePasswordBindingModel()
            {
                OldPassword = regInfo.OldPassword,
                NewPassword = regInfo.NewPassword,
    ...
    public class ResetPasswordBindingModel
    {
        ...
        public static implicit operator ResetPassword(ResetPasswordBindingModel registerMdl)
        {
            return new ResetPassword()
            {
                Code = registerMdl.Code,
                Email = registerMdl.Email,
                Password = registerMdl.Password,
                ConfirmPassword = registerMdl.ConfirmPassword
            };
        }

        public static implicit operator ResetPasswordBindingModel(ResetPassword regInfo)
        {
    ...
    public class LinkedInProfile
    {
        ...
        {
            SiteStandardProfileRequest = new SiteStandardProfileRequest();
            Positions = new Positions();
            Location = new Location();
            ApiStandardProfileRequest = new ApiStandardProfileRequest();
        }
    }
